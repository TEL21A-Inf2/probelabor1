 ...
 *
 * Implementieren Sie für diesen Datentyp die unten vorgegebene Methode Size().
 * Die Methode soll die anzahl der Elemente liefern, die sich insgesamt in der Liste
 * befinden.
 */
